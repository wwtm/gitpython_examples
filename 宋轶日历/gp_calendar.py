...
for i in range(1, 13):
    ...
    # 单元格填充色属性设置
    fill = PatternFill("solid", fgColor="B5B5B5")
    # 对单元格进行颜色填充
    ...
    # 设置年份及月份文本属性
    sheet.cell(row=3, column=1).font = Font(u'微软雅黑', size=16, bold=True, color='000000')
    sheet.cell(row=4, column=1).font = Font(u'微软雅黑', size=16, bold=True, color='000000')
